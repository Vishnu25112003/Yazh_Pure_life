        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-white/70 text-sm leading-relaxed">
              Providing pure, safe, and healthy drinking water solutions for
              homes and businesses across Tamil Nadu.
            </p>
            <div className="flex gap-2 pt-1">
              ...
              <a
                href="mailto:info@yazhpurelife.com"
                className="w-8 h-8 rounded bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors"
                aria-label="Email"
              >
